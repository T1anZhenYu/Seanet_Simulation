...
#ifndef SEANET_HEADER_H_
#define SEANET_HEADER_H_
 ...
 */
class SeanetHeader_ : public Header
{
public:
  SeanetHeader_();
  SeanetHeader_(uint8_t at, uint8_t pt);
  SeanetHeader_(uint8_t at, uint8_t pt, uint8_t dst);
...
private:
  ...
  uint8_t is_dst;
  uint8_t interface_num; // edge identifier.
