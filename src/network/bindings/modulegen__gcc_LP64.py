...
def register_types(module):
    ...
    ## seanet-address.h (module 'network'): ns3::SeanetAddress [class]
    module.add_class('SeanetAddress')
    ...
    ## queue.h (module 'network'): ns3::Queue<ns3::SeanetAddress> [class]
    module.add_class('Queue', parent=root_module['ns3::QueueBase'], template_parameters=['ns3::SeanetAddress'])
    typehandlers.add_type_alias('ns3::SeanetAddress', 'ns3::Queue< ns3::SeanetAddress > ItemType')
    typehandlers.add_type_alias('ns3::SeanetAddress*', 'ns3::Queue< ns3::SeanetAddress > ItemType*')
    typehandlers.add_type_alias('ns3::SeanetAddress&', 'ns3::Queue< ns3::SeanetAddress > ItemType&')
    module.add_typedef(root_module['ns3::SeanetAddress'], 'ItemType')
    ...
    module.add_class('DropTailQueue', parent=root_module['ns3::Queue< ns3::SeanetAddress >'], template_parameters=['ns3::SeanetAddress'])
