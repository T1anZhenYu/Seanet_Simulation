 ...
 *
 */
class MulticastClientApplicationv4 : public Application
{
public:
  /**
  ...
  MulticastClientApplicationv4 ();

  virtual ~MulticastClientApplicationv4 ();
  ...
  std::priority_queue<Time> NeighDelayQueue;
protected:
...
private:
  ...
  Time LookUpNeighDelay(Ipv4Address);
  Time AddNeighDelay(Ipv4Address,Time);
  typedef sgi::hash_map<Ipv4Address, Time, Ipv4AddressHash> NeighDelayTable;//
  /**
   * \brief Send a packet
   */
  void Write (void);
