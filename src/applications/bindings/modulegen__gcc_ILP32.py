...
def register_types(module):
    ...
    ## my-udp-server.h (module 'applications'): ns3::SwitchApplication [class]
...
def register_Ns3UdpClient_methods(root_module, cls):
    ...
    cls.add_method('StopApplication', 
                   ...
                   visibility='private', is_virtual=True)
    return
def register_Ns3StorageClientApplication_methods(root_module, cls):
    ## udp-client.h (module 'applications'): ns3::StorageClientApplication::StorageClientApplication(ns3::StorageClientApplication const & arg0) [constructor]
    cls.add_constructor([param('ns3::StorageClientApplication const &', 'arg0')])
    ## udp-client.h (module 'applications'): ns3::StorageClientApplication::StorageClientApplication() [constructor]
    cls.add_constructor([])
    ## udp-client.h (module 'applications'): static ns3::TypeId ns3::StorageClientApplication::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## udp-client.h (module 'applications'): void ns3::StorageClientApplication::SetRemote(ns3::Address ip, uint16_t port) [member function]
    cls.add_method('SetRemote', 
                   'void', 
                   [param('ns3::Address', 'ip'), param('uint16_t', 'port')])
    ## udp-client.h (module 'applications'): void ns3::StorageClientApplication::SetRemote(ns3::Address addr) [member function]
    cls.add_method('SetRemote', 
                   'void', 
                   [param('ns3::Address', 'addr')])
    ## udp-client.h (module 'applications'): void ns3::StorageClientApplication::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## udp-client.h (module 'applications'): void ns3::StorageClientApplication::StartApplication() [member function]
    cls.add_method('StartApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## udp-client.h (module 'applications'): void ns3::StorageClientApplication::StopApplication() [member function]
    cls.add_method('StopApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
...
def register_Ns3ResolutionApplication_methods(root_module, cls):
    ## udp-client.h (module 'applications'): ns3::ResolutionApplication::ResolutionApplication(ns3::ResolutionApplication const & arg0) [constructor]
    cls.add_constructor([param('ns3::ResolutionApplication const &', 'arg0')])
    ## udp-client.h (module 'applications'): ns3::ResolutionApplication::ResolutionApplication() [constructor]
    cls.add_constructor([])
    ## udp-client.h (module 'applications'): static ns3::TypeId ns3::ResolutionApplication::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## udp-client.h (module 'applications'): void ns3::ResolutionApplication::SetRemote(ns3::Address ip, uint16_t port) [member function]
    cls.add_method('SetRemote', 
                   'void', 
                   [param('ns3::Address', 'ip'), param('uint16_t', 'port')])
    ## udp-client.h (module 'applications'): void ns3::ResolutionApplication::SetRemote(ns3::Address addr) [member function]
    cls.add_method('SetRemote', 
                   'void', 
                   [param('ns3::Address', 'addr')])
    ## udp-client.h (module 'applications'): void ns3::ResolutionApplication::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## udp-client.h (module 'applications'): void ns3::ResolutionApplication::StartApplication() [member function]
    cls.add_method('StartApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## udp-client.h (module 'applications'): void ns3::ResolutionApplication::StopApplication() [member function]
    cls.add_method('StopApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
