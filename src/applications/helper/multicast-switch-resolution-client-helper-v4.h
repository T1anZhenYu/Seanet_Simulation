 ...
 */
#ifndef MULTICAST_SWITCH_RESOLUTION_CLIENT_HELPER_V4_H
#define MULTICAST_SWITCH_RESOLUTION_CLIENT_HELPER_V4_H
...
#include "ns3/multicast-switch-application-v4.h"
